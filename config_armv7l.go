...
// #cgo LDFLAGS: -static-libgcc -static-libstdc++ -L./libiec61850/lib/linux_armv7l -Wl,--start-group -liec61850 -lhal -lmbedtls -lmbedx509 -lmbedcrypto -Wl,--end-group -lpthread
import "C"
