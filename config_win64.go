...
// #cgo LDFLAGS: -static -static-libgcc -static-libstdc++ -L${SRCDIR}/libiec61850/lib/win64 -Wl,--start-group -liec61850 -lhal -lmbedtls -lmbedx509 -lmbedcrypto -Wl,--end-group -lws2_32
import "C"
