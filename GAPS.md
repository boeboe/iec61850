...
Coverage for **tag 1.1.0** vs **1.1.1** (current main, to be tagged 1.1.1). 1.1.1 adds MmsConnection, deferred connect/auth, full MMS client and MmsValue API, and four server MMS handlers (see [CHANGELOG.md](CHANGELOG.md)).

| Category | Functions | 1.1.0 | 1.1.1 |
|----------|-----------|-------|-------|
| **Client Connection** | 26 | 22 (85%) | 26 (**100%**) ✅ |
| **Client Read/Write** | 16 | 16 (**100%**) ✅ | 16 (**100%**) ✅ |
| **Client Async Ops** | 18 | 0 (0%) | 18 (**100%**) ✅ |
| **Named Variable Lists** | 10 | 0 (0%) | 10 (**100%**) ✅ |
| **Domain Discovery** | 12 | 0 (0%) | 12 (**100%**) ✅ |
| **File Services** | 10 | 9 (90%) | 10 (**100%**) ✅ |
| **Journal Client** | 6 | 0 (0%) | 6 (**100%**) ✅ |
| **MmsValue Constructors** | 15 | 0 (0%) | 15 (**100%**) ✅ |
| **MmsValue Setters** | 15 | 0 (0%) | 15 (**100%**) ✅ |
| **MmsValue Getters** | 15 | 0 (0%) | 15 (**100%**) ✅ |
| **BitString Operations** | 9 | 0 (0%) | 9 (**100%**) ✅ |
| **OctetString Operations** | 5 | 0 (0%) | 5 (**100%**) ✅ |
| **Array/Structure Ops** | 6 | 0 (0%) | 6 (**100%**) ✅ |
| **Type System** | 12 | 0 (0%) | 12 (**100%**) ✅ |
| **Server Configuration** | 10 | 0 (0%) | 10 (**100%**) ✅ |
| **Server Handlers** | 6 | 2 (33%) | 6 (**100%**) ✅ |
| **Server Journals** | 4 | 0 (0%) | 0 (0%) ❌ |

**1.1.0 notes:** No `MmsConnection`; no `NewClientWithoutConnect` / `ConnectWithAuth` / `ConnectAsync`; no MmsValue/type-system API; only `SetFileAccessHandler` and `InstallVariableListAccessHandler` on server; file services lack `GetFileDirectoryExEntries`.  
**1.1.1:** Full client and server MMS coverage except server-side journal creation (LogStorage SPI still missing).
